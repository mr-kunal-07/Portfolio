...
import { SiLeetcode, SiGeeksforgeeks, SiLinkedin, SiGithub, SiTwitter, SiWhatsapp } from 'react-icons/si';
const currentYear = new Date().getFullYear();

const Footer = () => {
  return (
    <FooterContainer id='footer'>
      <Logo>Kunal Jadhav</Logo>
      ...
      <SocialMediaIcons>
        ...
        <SocialMediaIcon href={Bio.instagram} target="display"><SiTwitter /></SocialMediaIcon>
        <SocialMediaIcon href={Bio.whatsapp} target="display"><SiWhatsapp /></SocialMediaIcon>
      </SocialMediaIcons>

      <Copyright>Copyright &copy; {currentYear} Kunal Jadhav | All Rights Reserved</Copyright>
    </FooterContainer>
  )
}
